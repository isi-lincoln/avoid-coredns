module github.com/isi-lincoln/avoid-coredns
...
require (
	...
	github.com/isi-lincoln/avoid v0.0.5 // indirect
...
replace github.com/coredns/coredns => github.com/isi-lincoln/avoid-coredns v0.0.2
